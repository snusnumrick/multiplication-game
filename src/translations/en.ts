...
export const englishTranslations: Translation = {
    ...
    visualStrategyLabel: "Visual: Count dots",
    patternStrategyLabel: "Pattern: Special tricks",
    countingStrategyLabel: "Steps: Count in steps",
    ...
    smartStrategiesDescriptionShow: "Smart tricks will be shown during practice.",
    smartStrategiesDescriptionHide: "Smart tricks will be hidden during practice.",
    ...
    foxyIntroPracticeMode: "Hello Eva! In practice mode you can calmly train the multiplication tables. Foxy is here to help you!",
    ...
    foxyIntroMemoryGame: "Find the matching cards, Eva! Foxy is keeping fingers crossed for this tricky memory game.",
    foxyIntroRealWorldMath: "Look, Eva! Here Foxy shows you where math is everywhere in daily life. Exciting, right?",
    ...
    advElevensConcept: "Advanced 11s trick for two-digit numbers",
    ...
    nearDoublesConcept: "Multiplying consecutive numbers like {a} × {b}.",
    ...
    benchmarkMnemonic: "Use an anchor to get close, then go to the answer!",
    ...
    strategyDecomposition: "Break down",
    ...
    strategyAdvancedElevens: "Advanced elevens trick",
    strategyMemoryTrick: "Memory trick",
    strategyBenchmark: "Benchmark",
