...
export const russianTranslations: Translation = {
    ...
    pureDoublesConcept: "Удваивай! Применяй знакомые тебе простые примеры.",
    ...
    leftToRightConcept: "Считай слева направо для скорости!",
    ...
    bfkfConcept: "Строй на основе более простых, известных фактов.",
