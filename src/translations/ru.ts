...
export const russianTranslations: Translation = {
    ...
    ninesFingerTrickStep3: "Пальцы слева от согнутого пальца — это десятки. У тебя поднято {firstDigit} палец(ев).",
    ninesFingerTrickStep4: "Пальцы справа — это единицы. У тебя поднято {secondDigit} палец(ев).",
    ...
    fivesHalfOfTenConcept: "При умножении на 5 используется трюк 'половина от 10'!",
    ...
    pureDoublesConcept: "Удваивай! Используй известные тебе меньшие факты.",
    ...
    benchmarkStep4: "Значит, нам нужно добавить еще {diff} группу(ы) по {b}, что составляет {diff_b}.",
    ...
    bfkfConcept: "Построение на основе более простых, известных фактов.",
