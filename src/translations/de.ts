...
export const germanTranslations: Translation = {
    ...
    fivesConcept: "Mit 5 multiplizieren nutzt den 'Hälfte von 10'-Trick!",
    fivesStep1: "Das ist 5 × {otherNum} (oder {otherNum} × 5).",
    fivesStep2: "Denke: (10 × {otherNum}) ÷ 2. Das ist {tenTimesOther} ÷ 2.",
