...
export const germanTranslations: Translation = {
    ...
    smartStrategiesTitle: "Clevere Tricks:",
    visualStrategyLabel: "Sehen: Punkte zählen",
    patternStrategyLabel: "Entdecken: Besondere Tricks",
    countingStrategyLabel: "Hüpfen: In Schritten zählen",
    ...
    smartStrategiesDescriptionShow: "Die cleveren Tricks werden beim Üben angezeigt.",
    smartStrategiesDescriptionHide: "Die cleveren Tricks werden beim Üben ausgeblendet.",
    practiceAreasTitle: "Übungsbereiche:",
    practiceAreasMessage: "Du übst gerade das Einmaleins für: {tables}. Das wird bestimmt super – die coolen Tipps helfen dir dabei!",
    keepTryingMessage: "Gib nicht auf! Probiere den coolen Tipp als Hilfe.",
    newStrategyLabel: "Neuer Trick",
    ...
    versionInfo: "Version 2.3 • Speziell für iPad optimiert",
    ...
    level1Desc: "Übe die 1er und 2er Reihe",
    level2Title: "Dreifacher Spaß",
    level2Desc: "Übe die 3er Reihe",
    ...
    level10Desc: "Übe alle Reihen zusammen!",
    ...
    realWorldDesc: "Entdecke mit Foxy, wo das Einmaleins im echten Leben vorkommt!",
    ...
    hardWorkerTitle: "Fleißiges Bienchen",
    ...
    expressionQuestion: "Welche Rechnung löst diese Aufgabe?",
    ...
    foxyRealWorldProblem: "Hier ist eine Alltagsaufgabe, Eva! Überlege, wie das Einmaleins helfen kann.",
    ...
    foxyGeneralCorrectMessage: "Super gemacht, Eva! Foxy freut sich mit dir!",
    ...
    skipCountingStep1: "Zähle in {a}er-Schritten:",
    skipCountingStep2: "{sequence}",
    skipCountingStep3: "Wir haben {b} Mal gezählt: {a} × {b} = {result}",
    decompositionStep1: "Teile {a} auf: {a} = {tens} + {ones}",
    decompositionStep2: "{a} × {b} = ({tens} + {ones}) × {b}",
    decompositionStep3: "= {tensResult} + {onesResult} = {result}",
    decompositionFallback: "{a} × {b} = {result}",
    ninesPatternConcept: "Praktischer 9er-Trick: Nutze die 'Von-10-abziehen-Methode",
    ninesStep1: "Sieh mal, das ist 9 × {other}",
    ninesStep2: "Denke: 10 × {other} = {result}",
    ninesStep3: "Dann ziehe {other} ab: {calc1} - {other} = {calc2}",
    ninesStep4: "Also ist 9 × {other} = {result}",
    ninesPattern: "9 mal etwas: erst mal 10 nehmen, dann die Zahl abziehen!",
    ninesMnemonic: "Denk dran: 9 ist nur 1 weniger als 10!",
    ...
    ninesFingerTrickConcept: "Nutze deine Finger für die 9er-Reihe!",
    ninesFingerTrickStep1: "Halte beide Hände vor dich.",
    ninesFingerTrickStep2: "Um 9 mit {other} zu malnehmen, klappe deinen {other}. Finger (von links) runter.",
    ninesFingerTrickStep3: "Die Finger links vom runtergeklappten Finger sind die Zehner. Du hast {firstDigit} Finger oben.",
    ninesFingerTrickStep4: "Die Finger rechts sind die Einer. Du hast {secondDigit} Finger oben.",
    ninesFingerTrickStep5: "Die Antwort lautet also {result}.",
    ninesFingerTrickPattern: "Klappe den N-ten Finger runter für 9×N. Linke Finger sind Zehner, rechte Finger sind Einer.",
    ...
    elevensStep1: "Besonderer 11er-Trick: 11 × {digit}",
    elevensStep2: "Schreibe einfach die Ziffer zweimal: {digit}{digit}",
    elevensStep3: "Prüfe: 11 × {digit} = {result}",
    elevensPattern: "11 × einzelne Ziffer = schreibe die Ziffer zweimal!",
    elevensMnemonic: "11 sieht gerne doppelt!",
    tensConcept: "Mit 10 malnehmen ist super einfach!",
    tensStep1: "Das ist {other} × 10 (oder 10 × {other}).",
    tensStep2: "Um eine Zahl mit 10 zu malnehmen, hänge einfach eine Null dran.",
    ...
    twosConcept: "Mit 2 malnehmen ist einfach verdoppeln!",
    twosStep1: "Das ist 2 × {otherNum} (oder {otherNum} × 2).",
    twosStep2: "Verdoppeln heißt, die Zahl zu sich selbst dazuzählen: {otherNum} + {otherNum}.",
    twosStep3: "Also, 2 × {otherNum} = {result}.",
    twosPattern: "Jede Zahl × 2 = diese Zahl + sie selbst.",
    twosMnemonic: "Zwei macht ein Paar, einfach doppelt nehmen!",
    fivesHalfOfTenConcept: "Mit 5 malnehmen nutzt den 'Hälfte von 10'-Trick!",
    fivesHalfOfTenStep1: "Das ist 5 × {otherNum} (oder {otherNum} × 5).",
    fivesHalfOfTenStep2: "Denke an 10 × {otherNum} = {tenTimesOther}. Die Hälfte davon ist {result}.",
    fivesHalfOfTenStep3: "Also ist 5 × {otherNum} = {result}.",
    fivesHalfOfTenPattern: "Jede Zahl × 5 = (diese Zahl × 10) ÷ 2.",
    fivesHalfOfTenMnemonic: "Fünf ist die Hälfte von zehn, leicht zu sehen!",
    fivesNickelCountingConcept: "Mit 5 malnehmen ist wie Fünfer-Münzen zählen!",
    ...
    fivesNickelCountingMnemonic: "Fünf, zehn, fünfzehn, zwanzig... zähle die Münzen!",
    pureDoublesConcept: "Verdoppeln! Nutze kleinere Aufgaben, die du kennst.",
    ...
    pureDoublesStep4: "Rechne zuerst {halfA} × {b} = {halfResult}.",
    ...
    squaresConcept: "Eine Zahl mit sich selbst malnehmen nennt man 'Quadrieren'.",
    ...
    advElevensStep2: "Teile die Ziffern von {b} auf: {firstDigit} und {secondDigit}.",
    advElevensStep3: "Zähle sie zusammen: {firstDigit} + {secondDigit} = {middleSum}.",
    advElevensStep4: "Setze die Summe in die Mitte: {firstDigit}{middleSum}{secondDigit}. Also, 11 × {b} = {result}.",
    advElevensStep5: "{middleSum} ist zweistellig. Nimm {middleDigit} für die Mitte, trage {carry} zur ersten Ziffer über.",
    ...
    nearDoublesConcept: "Aufeinanderfolgende Zahlen malnehmen wie {a} × {b}.",
    nearDoublesStep1: "Das ist {a} × {b}. Sieh mal, {b} ist {a} + 1.",
    nearDoublesStep2: "Das ist dasselbe wie ({a} × {a}) + {a}, also {aSquared} + {a}.",
    nearDoublesStep3: "Also, {aSquared} + {a} = {result}. Daher ist {a} × {b} = {result}.",
    nearDoublesPattern: "n × (n+1) = n² + n. (Nimm die kleinere Zahl zum Quadrat, dann zähle sie nochmal dazu).",
    nearDoublesMnemonic: "Nachbarn helfen: Quadriere die Kleine, zähle sie dazu!",
    memoryTrickConcept: "Ein lustiger Spruch oder eine Geschichte, um sich das zu merken!",
    memory_trick_6x8: "Sechs mal acht ist achtundvierzig. Also merke dir: 6 × 8 = 48!",
    ...
    benchmarkStep2: "Beginne mit einem einfachen Sprungbrett: {benchmark} × {b} = {benchmarkResult}.",
    benchmarkStep3: "Jetzt ist {a} {diff} mehr als {benchmark}.",
    benchmarkStep4: "Also brauchen wir noch {diff} mal {b}, das sind {diff_b}.",
    benchmarkStep5: "Zum Schluss zähle zusammen: {benchmarkResult} + {diff_b} = {result}.",
    benchmarkPattern: "Löse eine nahe, einfache Aufgabe und passe sie dann an.",
    benchmarkMnemonic: "Nutze ein Sprungbrett, um nahe heranzukommen, und spring dann zur Antwort!",
    ...
    roundingAndAdjustingStep3: "Der Unterschied ist {roundedNumber} - {a} = {difference}.",
    roundingAndAdjustingStep4: "Wir müssen {difference} × {b} = {adjustment} wieder abziehen.",
    roundingAndAdjustingStep5: "Ziehe die Anpassung ab: {initialProduct} - {adjustment} = {result}.",
    roundingAndAdjustingPattern: "a × b = (gerundetes_a × b) - ((gerundetes_a - a) × b)",
    roundingAndAdjustingMnemonic: "Aufrunden, malnehmen, dann das Extra wegnehmen!",
    leftToRightConcept: "Rechne von links nach rechts für mehr Geschwindigkeit!",
    leftToRightStep1: "Teile die größere Zahl auf: {b} = {tens} + {ones}.",
    leftToRightStep2: "Mal den Zehnerteil: {a} × {tens} = {tensResult}.",
    leftToRightStep3: "Mal den Einerteil: {a} × {ones} = {onesResult}.",
    leftToRightStep4: "Zähle die Ergebnisse zusammen: {tensResult} + {onesResult} = {result}.",
    leftToRightPattern: "a × (Z+E) = (a×Z) + (a×E)",
    leftToRightMnemonic: "Von links nach rechts, das macht Mathe leicht!",
    bfkfConcept: "Mit einfachen Aufgaben anfangen, die du schon kennst.",
    bfkfStep1: "Aufgabe: {a} × {b}.",
    bfkf3sStep2: "Teile 3 auf: 3 = 2 + 1.",
    bfkf3sStep3: "Also, 3 × {b} = (2 × {b}) + (1 × {b}).",
    bfkf3sStep4: "Wir wissen 2 × {b} ist {val1} (Verdoppeln), und 1 × {b} ist {val2}.",
    bfkf3sStep5: "Zähle sie zusammen: {sum1} + {sum2} = {result}.",
    bfkf3sPattern: "3×N = (2×N) + (1×N)",
    bfkf4sStep2: "Teile 4 auf: 4 = 2 + 2.",
    bfkf4sStep3: "Also, 4 × {b} = (2 × {b}) + (2 × {b}).",
    bfkf4sStep4: "Wir wissen 2 × {b} ist {val1} (Verdoppeln).",
    bfkf4sStep5: "Zähle sie zusammen: {sum1} + {sum2} = {result}.",
    bfkf4sPattern: "4×N = (2×N) + (2×N)",
    bfkf6sStep2: "Teile 6 auf: 6 = 5 + 1.",
    bfkf6sStep3: "Also, 6 × {b} = (5 × {b}) + (1 × {b}).",
    bfkf6sStep4: "Wir wissen 5 × {b} ist {val1} (Fünfer-Trick), und 1 × {b} ist {val2}.",
    bfkf6sStep5: "Zähle sie zusammen: {sum1} + {sum2} = {result}.",
    bfkf6sPattern: "6×N = (5×N) + (1×N)",
    bfkf7sStep2: "Teile 7 auf: 7 = 5 + 2.",
    bfkf7sStep3: "Also, 7 × {b} = (5 × {b}) + (2 × {b}).",
    bfkf7sStep4: "Wir wissen 5 × {b} ist {val1} (Fünfer-Trick), und 2 × {b} ist {val2} (Verdoppeln).",
    bfkf7sStep5: "Zähle sie zusammen: {sum1} + {sum2} = {result}.",
    bfkf7sPattern: "7×N = (5×N) + (2×N)",
    bfkf8sStep2: "Denke an 8 als 10 - 2.",
    bfkf8sStep3: "Also, 8 × {b} = (10 × {b}) - (2 × {b}).",
    bfkf8sStep4: "Wir wissen 10 × {b} ist {val1} (Zehner-Trick), und 2 × {b} ist {val2} (Verdoppeln).",
    bfkf8sStep5: "Ziehe sie ab: {sum1} - {sum2} = {result}.",
    bfkf8sPattern: "8×N = (10×N) - (2×N)",
    bfkfMnemonic: "Nutze, was du weißt, um herauszufinden, was du nicht weißt!",
    onesConcept: "Mit 1 malnehmen ist super einfach!",
    onesStep1: "Das ist {otherNum} × 1 (oder 1 × {otherNum}).",
    onesStep2: "Jede Zahl, die mit 1 malgenommen wird, bleibt einfach sie selbst.",
    ...
    visualArrayConcept: "Stell dir {a} × {b} vor: {b} Gruppen mit je {a} Sachen",
    visualStep1: "Mache {b} Gruppen mit je {a} Punkten",
    ...
    decompositionConcept: "Teile in einfachere Teile auf",
    decompositionPattern: "Teile große Zahlen in Zehner und Einer auf",
    strategyLabel: "{strategy}",
    strategyLabelSuffix: "Trick",
    keyConceptLabel: "💡 Wichtig:",
    visualLabel: "👁️ So siehts aus:",
    stepsLabel: "📝 Schritte:",
    patternLabel: "🔍 Muster:",
    memoryTrickLabel: "🧠 Merkspruch:",
    realWorldLabel: "🌍 Im echten Leben:",

    // Strategy Names
    strategyVisualArray: "Punkte anordnen",
    strategyPatternRecognition: "Muster erkennen",
    strategySkipCounting: "In Schritten zählen",
    strategyDecomposition: "Aufteilen",
    strategyDoubles: "Verdoppeln",
    ...
    strategySquares: "Quadratzahlen",
    strategyNearDoubles: "Fast-Doppelte",
    strategyBuildingKnownFacts: "Mit Bekanntem anfangen",
    strategyOnes: "Einser-Trick",
    strategyTens: "Zehner-Trick",
    strategyNines: "Neuner-Trick",
    strategyNinesDigitSum: "Neuner-Quersummen-Trick",
    strategyNinesFingerTrick: "Neuner-Finger-Trick",
    strategyElevens: "Elfer-Trick",
    strategyAdvancedElevens: "Erweiterter Elfer-Trick",
    strategyMemoryTrick: "Merkspruch",
    strategyBenchmark: "Ankerpunkt",
    strategyRoundingAndAdjusting: "Runden und Anpassen",
    strategyLeftToRight: "Links nach Rechts",
